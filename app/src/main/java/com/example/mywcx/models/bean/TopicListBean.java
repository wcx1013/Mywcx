package com.example.mywcx.models.bean;
...
public class TopicListBean {
    ...
    @Generated(hash = 1287507727)
    public TopicListBean(Long id, String title, String content, String avatar,
            String item_pic_url, String subtitle, int topic_category_id, String price_info,
            String read_count, String scene_pic_url, int topic_template_id, int topic_tag_id,
            int sort_order, int is_show) {
        this.id = id;
        this.title = title;
